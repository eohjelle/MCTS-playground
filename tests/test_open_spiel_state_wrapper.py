...
class MockOpenSpielState:
    ...
    def __init__(self):
        ...
        self._current_rewards = [0.0, 0.0]     # What rewards() returns (resets for current player)
...
class TestOpenSpielStateWrapper(unittest.TestCase):
    ...
    def test_simulated_intermediate_rewards(self):
        ...
        for move in moves:
            if (not state.is_terminal) and (move in state.legal_actions):
                ...
                actions_taken.append((current_player, move, rewards_before, rewards_after))
    ...
    def test_connect_four_winning_scenario(self):
        ...
        moves = [3, 5, 2, 1, 3, 1, 3, 0, 2, 0, 4, 6, 4, 6, 4, 6, 4]  # Setup a winnable position
