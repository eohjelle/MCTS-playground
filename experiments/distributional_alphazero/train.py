from .DistributionalAlphaZero import DAZTrainingAdapter, DistributionalAlphaZeroConfig
...
def main(argv):
    ...
    if FLAGS.buffer_path is not None:
        ...
        buffer_path = f"experiments/tsds/data/mcts1200_{tm_type}_training_data.pt"
    else:
        buffer_path = None
    ...
    config = TrainerConfig(
        ...
        algorithm_params=default_config,
        checkpoint_dir=f"checkpoints/distributional_alphazero/{FLAGS.name or 'default'}",
        tensor_mapping=tensor_mapping,
        training_adapter=DAZTrainingAdapter(params=default_config),
        ...
        wandb_project="TS-DAZ-ConnectFour" if FLAGS.wandb else None,
        ...
        learning_min_buffer_size=10 * batch_size,
        buffer_max_size=100 * batch_size,
        learning_min_new_examples_per_step=1 * batch_size
