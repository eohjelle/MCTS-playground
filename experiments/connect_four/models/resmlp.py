...
class ResMLP(nn.Module):
    def __init__(self, num_rows: int, num_cols: int, num_residual_blocks: int, residual_dim: int, hidden_size: int):
        super().__init__()
        self.num_rows = num_rows
        self.num_cols = num_cols
        
        io_size = 2 * self.num_rows * self.num_cols
        
        self.input_layer = nn.Linear(io_size, residual_dim)
        ...
        self.policy_head = nn.Linear(residual_dim, self.num_cols)
